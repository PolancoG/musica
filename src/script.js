let playlist = [ {
  ...
  'audio': "assets/Justin Bieber  - Stay.mp3",
}, {
  'title': 'Lil Nas X - Industry Baby ft Jack Harlow',
  'audio': "assets/Lil Nas X  - Industry Baby ft Jack Harlow.mp3",
}, {
  'title': 'Oliver Tree - Life Goes On',
  'audio': "assets/Oliver Tree - Life Goes On.mp3",
}, {
...
function switchOther( ) {
  $( '#skin' ).attr( 'class', 'other audio-player' );
  $( '.inner' ).css( 'background', '#fff' );
  $( '.title' ).css( 'color', '#fff' );
  $( '.time' ).css( 'color', '#fff' );
  $( '.fa-volume-up' ).css( {
